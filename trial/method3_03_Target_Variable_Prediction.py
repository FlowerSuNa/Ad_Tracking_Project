...
ad_test = pd.read_csv('test_modify3.csv')
print(ad_test.shape)
...
feat = [feat1, feat2, feat3, feat4, feat5, feat6, feat7, feat8, feat9, feat10, feat11]
name = ['feat1', 'feat2', 'feat3', 'feat4', 'feat5', 'feat6', 'feat7', 'feat8', 'feat9', 'feat10', 'feat11']
...
for s in sample:
    ...
    ## Import data
    ad_train = pd.read_csv('train_'+ s + '_modify3.csv')
    ...
    for f,n in zip(feat,name):
        ...
        submission.to_csv(s + '_submission3_lgbm_' + n+ '.csv', index=False)
